  ...
  return (
    <div className="Header">
      <div className={"LangSwitcher"}>
        <span className={"LangSwitcherDisabled"}>EN</span>.
        <span className={"LangSwitcherActive"}>RU</span>
      </div>
      ...
      <div className={"NavMenu"}>
        {showMenuState && (
          <div className={mobileMenuClasses}>
            <NavLink
              onClick={() => setShowMenuState(false)}
              exact
              to="/projects"
              className={"MenuItem"}
            ...
            <NavLink
              ...
              activeClassName={"MenuActive"}
            >
              <span className={"MenuItemTitle"}>ЭТАПЫ</span>
            </NavLink>
            <a
              onClick={() => setShowMenuState(false)}
              href="#contact"
            ...
            <div className="NavMenu__close" onClick={closeMenu}>
              ✕
            </div>
          </div>
        )}
